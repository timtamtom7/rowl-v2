...
export const CHANNEL_MAP = {
  ...
  listGitBranches: invoke(RPC_CHANNELS.git.LIST_BRANCHES),
  checkoutGitBranch: invoke(RPC_CHANNELS.git.CHECKOUT_BRANCH),
  createGitBranch: invoke(RPC_CHANNELS.git.CREATE_BRANCH),
  getGitStatus: invoke(RPC_CHANNELS.git.GET_STATUS),
  getGitDetailedStatus: invoke(RPC_CHANNELS.git.GET_DETAILED_STATUS),
  commitGitChanges: invoke(RPC_CHANNELS.git.COMMIT),
  getGitDiff: invoke(RPC_CHANNELS.git.DIFF),
  stageGitFiles: invoke(RPC_CHANNELS.git.STAGE),
  unstageGitFiles: invoke(RPC_CHANNELS.git.UNSTAGE),
  discardGitFiles: invoke(RPC_CHANNELS.git.DISCARD),
